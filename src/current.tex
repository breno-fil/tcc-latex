...
\thispagestyle{empty}
    ...
    Por exemplo, um desenvolvedor pode optar por usar um serviço de LLM específico, como \textit{OpenAI} ou \textit{Hugging Face}, ou selecionar um banco vetorial diferente, como \textit{Pinecone} \footnote{\citeurl{pinecone}} ou \textit{Elasticsearch} \footnote{\citeurl{elasticsearch}}.
